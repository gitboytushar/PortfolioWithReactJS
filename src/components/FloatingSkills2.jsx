// This is a sub-component for the Skills-component - just the row flows in reverse order
import React from 'react'
import { SKILLS } from '../constants'

const FloatingSkills = () => {
  return (
    <div className='flex flex-row-reverse items-center justify-center gap-8 ml-8 md:gap-12 md:ml-12 lg:gap-20 lg:ml-20'>
