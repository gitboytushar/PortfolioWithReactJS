...
const Scroll2TopFloatingButton = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className='scroll2top-btn fixed bottom-5 right-5 lg:right-12 p-3 rounded-full backdrop-blur-lg cursor-pointer border border-white/50 bg-black/20 text-white/50 hover:border-white hover:text-white hover:scale-95 transition-all duration-300 ease-linear'
