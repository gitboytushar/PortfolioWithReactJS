                  ...
                  <CardContent>
                    <motion.div variants={parentVariant}>
                      <div className='py-2 md:py-6 flex flex-col md:flex-row text-center md:text-start items-center justify-center gap-4 md:gap-8 h-full md:h-[280px] px-2 md:px-0'>
                        <img
                          className='w-[80vw] h-[250px] md:w-[350px] md:h-full object-cover rounded-xl brightness-90 border-none p-0.5 bg-gradient-to-br from-indigo-300 to-purple-600'
                          src={hobby.image}
                          alt='hobby image'
                        />
                        <motion.div
                        ...
                        >
                          <h3 className='text-2xl lg:text-3xl mb-3 bg-gradient-to-br from-indigo-300 to-purple-600 text-transparent bg-clip-text font-medium w-52 brightness-125'>
                            {hobby.name}
                          </h3>
