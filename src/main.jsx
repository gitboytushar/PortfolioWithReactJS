...
// custom loader
const Loading = () => (
  <div className='flex items-center justify-center w-full h-full fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2'>
    <p className='flex items-center justify-center gap-2 md:gap-4 text-center text-sm md:text-2xl'>
